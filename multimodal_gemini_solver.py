...
def test_multimodal_solver():
    ...
    result_multimodal = solver.solve_captcha_multimodal(latest_image, latest_audio)
    
    print(f"\n🖼️  Test 2: IMAGE seule")
    ...
    print("=" * 50)
    print(f"🔥 Multimodal: '{result_multimodal}'")
    print(f"🖼️  Image seule: '{result_image}'")
    print(f"🎧 Audio seul:  '{result_audio}'")
    
    # Recommandation
    if result_multimodal:
        print(f"\n💡 RECOMMANDATION: Utiliser résultat multimodal '{result_multimodal}'")
        return result_multimodal
    elif result_image:
        print(f"\n💡 FALLBACK: Utiliser résultat image '{result_image}'")
        return result_image
    elif result_audio:
        print(f"\n💡 FALLBACK: Utiliser résultat audio '{result_audio}'")
        return result_audio
    else:
